...
import{r as e}from"./rolldown-runtime-hePW80VL.js";import{n as t,t as n}from"./jsx-runtime-096o_Uk7.js";import{h as r}from"./index-DlilDupT.js";var i=e(t(),1),a=`/FANGpreparations/assets/sql-wasm-DfANybxk.wasm`,o={ecommerce:`-- E-commerce sample DB. Deliberate teaching features:
...
FROM monthly
ORDER BY month;`,ordered:!0,hint:`A running window SUM for the numerator, a plain scalar subquery over the same CTE for the denominator. The last row must land on 100.`}],m=n(),h=500;function g(e,t,n=!1){if(!e||!t)return!e&&!t;if(e.columns.length!==t.columns.length)return!1;let r=e=>{let t=e.values.map(e=>JSON.stringify(e));return(n?t:[...t].sort()).join(`
