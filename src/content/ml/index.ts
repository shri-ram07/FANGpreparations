...
export const ml: SubjectDef = {
  ...
  modules: [
    ...
    mod('ml-l3-feature-engineering', 3, 'Feature Engineering and Data Leakage', 24, () => import('./l3-feature-engineering')),
    ...
    mod('ml-l3-from-scratch', 3, 'Writing the Training Loop Yourself', 24, () => import('./l3-from-scratch')),
    mod('ml-l3-projects', 3, 'Running an ML Project', 18, () => import('./l3-projects')),
  ],
}
