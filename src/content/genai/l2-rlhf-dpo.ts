...
**Alignment** is the name for the work of moving a model from the first to the second: making it helpful, honest and safe, rather than merely likely. That is the whole subject of this module.`,
    },
    {
      ...
      component: 'Plot',
      props: {
          title: 'The DPO loss, and what β actually controls',
          notice: 'DPO charges −log σ(β × margin), where the margin is how much more the model prefers the chosen answer over the rejected one. At margin 0 — no preference at all — the loss is ln 2 = 0.693 for any β. β sets how sharply the loss reacts: at β = 1 a margin of 2 drops the loss to 0.127, while at β = 0.1 the same margin only reaches 0.598. Small β means the model is barely pushed away from the reference; large β means it is pushed hard and can overfit the preference data.',
          kind: 'line',
          xLabel: 'implicit reward margin (chosen − rejected)',
          yLabel: 'DPO loss',
          yMin: 0,
          series: [
            {
              name: 'β = 0.1',
              points: [[-4, 0.913], [-3.9, 0.907], [-3.8, 0.9011], [-3.7, 0.8952], [-3.6, 0.8893], [-3.5, 0.8834], [-3.4, 0.8775], [-3.3, 0.8717], [-3.2, 0.8659], [-3.1, 0.8601], [-3, 0.8544], [-2.9, 0.8486], [-2.8, 0.8429], [-2.7, 0.8372], [-2.6, 0.8316], [-2.5, 0.8259], [-2.4, 0.8203], [-2.3, 0.8147], [-2.2, 0.8092], [-2.1, 0.8036], [-2, 0.7981], [-1.9, 0.7927], [-1.8, 0.7872], [-1.7, 0.7818], [-1.6, 0.7763], [-1.5, 0.771], [-1.4, 0.7656], [-1.3, 0.7603], [-1.2, 0.7549], [-1.1, 0.7497], [-1, 0.7444], [-0.9, 0.7392], [-0.8, 0.7339], [-0.7, 0.7288], [-0.6, 0.7236], [-0.5, 0.7185], [-0.4, 0.7133], [-0.3, 0.7083], [-0.2, 0.7032], [-0.1, 0.6982], [0, 0.6931], [0.1, 0.6882], [0.2, 0.6832], [0.3, 0.6783], [0.4, 0.6733], [0.5, 0.6685], [0.6, 0.6636], [0.7, 0.6588], [0.8, 0.6539], [0.9, 0.6492], [1, 0.6444], [1.1, 0.6397], [1.2, 0.6349], [1.3, 0.6303], [1.4, 0.6256], [1.5, 0.621], [1.6, 0.6163], [1.7, 0.6118], [1.8, 0.6072], [1.9, 0.6027], [2, 0.5981], [2.1, 0.5936], [2.2, 0.5892], [2.3, 0.5847], [2.4, 0.5803], [2.5, 0.5759], [2.6, 0.5716], [2.7, 0.5672], [2.8, 0.5629], [2.9, 0.5586], [3, 0.5544], [3.1, 0.5501], [3.2, 0.5459], [3.3, 0.5417], [3.4, 0.5375], [3.5, 0.5334], [3.6, 0.5293], [3.7, 0.5252], [3.8, 0.5211], [3.9, 0.517], [4, 0.513]],
            },
            {
              name: 'β = 0.5',
              points: [[-4, 2.1269], [-3.9, 2.083], [-3.8, 2.0394], [-3.7, 1.996], [-3.6, 1.953], [-3.5, 1.9102], [-3.4, 1.8678], [-3.3, 1.8257], [-3.2, 1.7839], [-3.1, 1.7425], [-3, 1.7014], [-2.9, 1.6607], [-2.8, 1.6204], [-2.7, 1.5805], [-2.6, 1.541], [-2.5, 1.5019], [-2.4, 1.4633], [-2.3, 1.4251], [-2.2, 1.3873], [-2.1, 1.3501], [-2, 1.3133], [-1.9, 1.277], [-1.8, 1.2412], [-