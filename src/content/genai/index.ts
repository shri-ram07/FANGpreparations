...
export const genai: SubjectDef = {
  ...
  modules: [
    ...
    mod('genai-l2-finetuning-lora', 2, 'Fine-Tuning: Full FT, LoRA & QLoRA', 55, () => import('./l2-finetuning-lora')),
    mod('genai-l2-rlhf-dpo', 2, 'Alignment: RLHF, Reward Models & DPO', 55, () => import('./l2-rlhf-dpo')),
    mod('genai-l2-inference-optimization', 2, 'Inference: KV-Cache, Quantization & Serving', 55, () => import('./l2-inference-optimization')),
    mod('genai-l3-prompt-engineering', 3, 'Prompt Engineering That Actually Works', 45, () => import('./l3-prompt-engineering')),
