...
export const genai: SubjectDef = {
  ...
  modules: [
    ...
    mod('genai-l1-build-gpt-capstone', 1, 'Build GPT: The Capstone', 18, () => import('./l1-build-gpt-capstone')),
    mod('genai-l2-pretraining-scaling', 2, 'Pretraining: Data, Memory and Cost', 20, () => import('./l2-pretraining-scaling')),
    mod('genai-l2-finetuning-lora', 2, 'Fine-Tuning and LoRA', 18, () => import('./l2-finetuning-lora')),
    mod('genai-l2-rlhf-dpo', 2, 'RLHF and DPO: Learning From Preferences', 20, () => import('./l2-rlhf-dpo')),
    mod('genai-l2-inference-optimization', 2, 'Inference Optimization', 20, () => import('./l2-inference-optimization')),
    mod('genai-l3-prompt-engineering', 3, 'Prompting: What Works and Why', 20, () => import('./l3-prompt-engineering')),
    mod('genai-l3-embeddings-vector-db', 3, 'Vector Search at Scale', 20, () => import('./l3-embeddings-vector-db')),
    mod('genai-l3-rag', 3, 'Retrieval-Augmented Generation', 20, () => import('./l3-rag')),
    mod('genai-l3-agents-tools', 3, 'Agents and Tool Use', 20, () => import('./l3-agents-tools')),
    mod('genai-l3-evaluation-safety', 3, 'Evaluating and Guarding an LLM System', 20, () => import('./l3-evaluation-safety')),
  ],
}
